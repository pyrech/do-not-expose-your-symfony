...
1. [Fork it](https://github.com/pyrech/do-not-expose-your-symfony/fork_select)
2. improve it
...
```shell
git remote add upstream https://github.com/pyrech/do-not-expose-your-symfony.git
```
